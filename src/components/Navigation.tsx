...
export function Navigation({ currentPage, user, onNavigate, onLogout, onConnectWallet }: NavigationProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 backdrop-blur-2xl bg-slate-900/80 border-b border-cyan-500/10 shadow-lg shadow-cyan-500/5">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            {onConnectWallet && (
              <Button
                ...
                className="hidden md:flex items-center gap-2 bg-gradient-to-r from-cyan-600/90 to-teal-600/90 hover:from-cyan-500 hover:to-teal-500 text-white font-semibold border border-cyan-400/20 hover:border-cyan-400/40 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 transition-all duration-300"
                size="sm"
              >
